...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Successful Sms</h5>

                  <?php

if(!isset($_GET["trans_id"])){
    pagination_history_before("ssms","true");
}
elseif(empty($_GET["trans_id"])){
  pagination_history_before("ssms","true");
    ...
    if(is_numeric($_GET["trans_id"])){
        $id = $_GET["trans_id"];
        pagination_history_before("ssms","true","AND id = '$id'");
    }
    else{
        pagination_history_before("ssms","true");
    }
...
?>
    ...
    <td colspan="8">No Successful Sms Recorded</td>
    </tr>
<?php
}else{
